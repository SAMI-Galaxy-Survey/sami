...
inputfile = '../SAMIcubing_output/10000122red_50pix_05arcsec_off045_covar_compressed.fits'
# provide path + filename for output file; by default output file will be written in current run directory:
outputfile = '../SAMIcubing_output/10000122red_50pix_05arcsec_off045_covar_reconstructed'
